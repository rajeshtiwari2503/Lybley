            ...
            <div className="container mt-5">
                <div className="row pt-3 pb-3" style={{backgroundColor:"#F5DEB3"}}>
                    ...
                    <div className="col-6 col-md-4 col-lg-4">
                        ...
                        <h6 className='pt-5'>Lining Dishwasher</h6>
                        <h6 className='pt-1'>Microwave Oven</h6>
                        <h6 className='pt-1'>Garage Door</h6>
                        <h6 className='pt-1'>Permits & Code Upgrades</h6>
                        <h6 className='pt-1'>Refrigerant Recapture & disposal</h6>
                        <h6 className='pt-1'>Equipment Disposal</h6>
                        <h6 className='pt-1'>Structural Modification</h6>
                    </div>
                    <div className="col-6 col-md-4 col-lg-4">
