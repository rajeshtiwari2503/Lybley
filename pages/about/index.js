        ...
        <div>
            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-12 col-md-6 col-lg-6 p-md-5 p-lg-5 pt-2 d-flex justify-content-center align-items-center">
                        <h2 className='fw-bold'>We’re a home care and repair innovation company</h2>
                    </div>
                </div>
            </div>
            <div className="bg-dark text-center py-5">
                <h6 className='text-primary'><small>MISSION STATEMENT</small></h6>
                <h2 className='text-white fw-bold'>Our inspiration is our fuel</h2>
                <h4 className='text-white'>To make caring for a home completely carefree.</h4>
            </div>
